    ...
    <div className="main">
        ...
        <div className="all-questions">
          <div className="all-questions-container">
            ...
            <div className="question-answer">
              <p>{convertHtmlToReact(questionData?.body)}</p>
              <div className="author">
                <small>asked {new Date(questionData?.created_at).toLocaleString()}</small>
                <div className="auth-details">
                  <Avatar name src={questionData?.user?.photo} />
                ...
                {show && (
                  <div className="title">
                    ...
                    <button onClick={handleComment}
                      style={{ maxWidth: "fit-content", }}>Add comment</button>
                  </div>
                )}
              </div>
            </div>
        ...
        <div style={{ flexDirection: "column", }} className="all-questions">
          <p style={{ marginBottom: "20px", fontSize: "1.3rem", fontWeight: "300" }}>{questionData?.answerDetails?.length}Answer(s)</p>
          {
            questionData?.answerDetails?.map((_q) => (<div key={_q?._id}
              ...
              <div className="question-answer">
                <p>{convertHtmlToReact(_q?.answer)}</p>
                <div className="author">
      ...
      <div className="main-answer">
        ...
        <ReactQuill
          ...
          className="react-quill" theme="snow" style={{ height: "200px", }} />
      </div>
      <button type="submit"
        onClick={handleSubmit}
        style={{ maxWidth: "fit-content", marginTop: "90px", }}> Post your answer</button>
    </div>
  )
}
